function makeSortable (table-dom) {
	var ths = table-dom.getElementsByTagName("th");
...
function makeFilterable (table-dom) {
	var e = document.createElement("input");
    e.type = "text";
    e.onchange = filter;
	table-dom.parentNode.insertBefore(e,table-dom);
	return table-dom;
}
